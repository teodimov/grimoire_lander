  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#181A1B] text-black dark:text-gray-100 p-8 font-mono px-8 py-20 font-consolas">
      <div className="max-w-xl mx-auto">
        <h1 className="text-3xl font-bold mb-6">The ML Pocket Primer</h1>
        <ul className="space-y-4 text-sm text-gray-700 dark:text-gray-300">
          ...
          <li>
            AI research should be accessible to all. This primer provides
          ...
          <li className="opacity-50">Last updated: 7/28/25</li>
        </ul>
      </div>
    </div>
  );
